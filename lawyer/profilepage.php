...
$clid=$_SESSION['lawyer_id'];

$query="SELECT lawyer_first_name, lawyer_last_name, lawyer_email, lawyer_phone_no, lawyer_city, lawyer_address, lawyer_rating, specialization from lawyer_login where lawyer_id=$clid";
$result = mysqli_query($con, $query);
$user_data = mysqli_fetch_assoc($result);
$fname=$user_data['lawyer_first_name'];
$lname=$user_data['lawyer_last_name'];
$email=$user_data['lawyer_email'];
$phone=$user_data['lawyer_phone_no'];
$city=$user_data['lawyer_city'];
$address=$user_data['lawyer_address'];
$rating=$user_data['lawyer_rating'];
$special=$user_data['specialization'];
//$img_data=$user_data['lawyer_image'];
...
//$stmt = $con->prepare("SELECT lawyer_first_name, lawyer_last_name, lawyer_email, lawyer_phone_no, lawyer_city, lawyer_address, lawyer_rating, specialization, image_type from lawyer_login");
