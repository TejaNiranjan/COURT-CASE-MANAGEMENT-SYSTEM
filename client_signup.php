...
<body>
        ...
        if(isset($_POST["client-signup"])){
            ...
            if ($con) {
                ...
                if ($numRows > 0) {
                    ...
                    $query = "INSERT INTO client (client_id, client_first_name, client_last_name, client_email, client_password, phone_no, address) VALUES
                    (3, '$firstname', '$lastname', '$email', '$hashedpwd', $phoneno, '$address')";
                   // $stmt = $con->prepare("INSERT INTO client(client_first_name, client_last_name, client_email, client_password,phone_no, address)
                   // VALUES (?,?,?,?,?,?)");
                    //$stmt->bind_param('ssssss', $firstname, $lastname, $email, $hashedpwd,$phoneno,$address);
                    //$stmt->execute();
    ...
    <form action="client_signup.php" method="post" style="border:1px solid #ccc">
        <div class="container">
          ...
          <input type="text" placeholder="Enter Phone_no" name="client-phoneno" required>

          <label for="address"><b>address</b></label>
          <input type="text" placeholder="Enter address" name="client-address" required>
          <label>
