    ...
    if(isset($_POST["addcase"])){
        ...
        if ($con) {
           ...
           /* $stmt = $con->prepare("INSERT INTO cases(
            ...
            $stmt->execute();*/
            $query = "INSERT INTO cases(case_id,case_type,case_details,next_hearing_date,prev_hearing_date,case_status,court_name,lawyer_id_assigned,lawyer_status,clientforcase_id) VALUES
            ('$clientid','$casetype', '$casedetails',null,null,'$case_status',null,'$lawyerid',null,'$clientid')";
           $result = mysqli_query($con, $query);
            ...
            $query = "INSERT INTO notifications(client_id, lawyer_id, case_type, case_detail, accepted_status) VALUES(' $clientid','$lawyerid','$casetype',$casedetails', '$accepted_status')";
            $result = mysqli_query($con, $query);
            if ($result === -1) {
                echo "Error";
            } else {
