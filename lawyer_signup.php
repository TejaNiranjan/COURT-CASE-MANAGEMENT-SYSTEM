...
<body>
    ...
    <?php
        ...
        if(isset($_POST["lawyer-signup"])){
            ...
            $con;
            if ($con) {
                $query=" SELECT * FROM lawyer_login WHERE lawyer_id=(SELECT max(lawyer_id) FROM lawyer_login)";
                $result = mysqli_query($con, $query);

                $user_data = mysqli_fetch_assoc($result);
                $lawid=$user_data['lawyer_id'];
                $lawid++;
                ...
                if ($numRows > 0) {
                    ...
                    $query = "INSERT INTO lawyer_login (lawyer_id, lawyer_first_name, lawyer_last_name, lawyer_email, lawyer_password, lawyer_phone_no, lawyer_city, lawyer_address, lawyer_rating, specialization, lawyer_image) VALUES
                    ($lawid, '$firstname', '$lastname', '$email', '$hashedpwd', NULL, NULL, NULL, NULL, NULL, NULL)";
                     $result = mysqli_query($con, $query);
